...
```
.compass-harness/context/L3-specs/
├── specs/                          ← 当前系统需求（truth）
...
- `.compass-harness/context/L1-codebase-map/overview.md` — 项目功能索引
- `.compass-harness/context/L3-specs/specs/system.md` — 系统级需求
- `ls .compass-harness/context/L3-specs/specs/` — 已有能力域
- `ls .compass-harness/context/L3-specs/changes/` — 进行中的变更

根据需求定位涉及的功能和模块：

- `.compass-harness/context/L1-codebase-map/features/[功能名]/README.md`
- `.compass-harness/context/L2-rules/[模块名].md`
- `.compass-harness/context/L3-specs/specs/[能力域]/spec.md`（如已存在）
...
2. 更新 `.compass-harness/context/L4-session/active-session.md` 指向该变更
3. 开始执行 tasks.md
