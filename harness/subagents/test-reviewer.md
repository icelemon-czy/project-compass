...
- An implementation already exists and the parent needs an independent review.
- The test surface is large enough that a separate read-only pass reduces missed assumptions.

Do not use this role as a replacement for the `/review-tests` Skill; it is an optional independent pass.
