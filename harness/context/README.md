# Compass Harness Project Context

This directory becomes a project's `.compass-harness/context/` when `harness/` is copied into that project. Populate it in place using only current source code, configuration, tests, or confirmed requirements.
